...
public struct ez {
    ...
    static func pixelFloor(value: CGFloat) -> CGFloat {
        return CGFloat(floor(value / UIScreen.main.scale))
    }
    
    static func fromPixel(value: CGFloat) -> CGFloat {
...
//        UIApplication.shared.windows[0].rootViewController?.navigationController?.topViewController
...
//
//            let height = manager?.statusBarFrame.size.height
//            if height == 0 {
//                return 20
//            }else {
//                return manager?.statusBarFrame.size.height ?? 20
//            }
//
//        } else {
//
